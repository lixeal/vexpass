--[[  Rewrited by nettoxi | Repacked by 02xTeam
N      ██████   █████  ███           █████       █████    ██████████                                  ███    ███████████                   █████     ████████              ███████████                                   
I     ▒▒██████ ▒▒███  ▒▒▒           ▒▒███       ▒▒███    ▒▒███▒▒▒▒▒█                                 ▒███   ▒▒███▒▒▒▒▒███                ███▒▒▒███  ███▒▒▒▒███            ▒█▒▒▒███▒▒▒█                                   
G      ▒███▒███ ▒███  ████   ███████ ▒███████   ███████   ▒███  █ ▒  █████ █████  ██████   ██████    ▒███    ▒███    ▒███ █████ ████    ███   ▒▒███▒▒▒    ▒███ █████ █████▒   ▒███  ▒   ██████   ██████   █████████████  
H      ▒███▒▒███▒███ ▒▒███  ███▒▒███ ▒███▒▒███ ▒▒▒███▒    ▒██████   ▒▒███ ▒▒███  ███▒▒███ ███▒▒███   ▒███    ▒██████████ ▒▒███ ▒███    ▒███    ▒███   ███████ ▒▒███ ▒▒███     ▒███     ███▒▒███ ▒▒▒▒▒███ ▒▒███▒▒███▒▒███ 
...
local function createOriginialElements()
	local function createWindow()
		...
		headingSeperator.BackgroundColor3 = Color3.fromRGB(214, 142, 250)
	...
	local function createTab()
		...
		tab.Text = ""
		tab.TextColor3 = Color3.fromRGB(214, 142, 250)
		tab.TextSize = 18.000
		...
		tabText.Text = "N/A"
		tabText.TextColor3 = Color3.fromRGB(214, 142, 250)
		...
		tabSeperator.BackgroundColor3 = Color3.fromRGB(214, 142, 250)
		tabSeperator.BackgroundTransparency = 0
		tabSeperator.BorderColor3 = Color3.fromRGB(214, 142, 250)
	...
	local function createSection()
		...
		heading.BackgroundColor3 = Color3.fromRGB(214, 142, 250)
		heading.BorderSizePixel = 0
	...
	local function createTitle()
		...
		designGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(96, 85, 102)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(214, 142, 250)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(96, 85, 102))}
	...
	local function createToggle()
		...
		toggleImage.BackgroundColor3 = Color3.fromRGB(214, 142, 250)
	...
	local function createButton()
		...
		buttonCircle.BackgroundColor3 = Color3.fromRGB(214, 142, 250)
	...
	local function createSlider()
		...
		slider.BackgroundColor3 = Color3.fromRGB(214, 142, 250)
...
function Library.new(windowName: string, constrainToScreen: boolean?, width: number?, height: number?, visibilityKeybind: string?, backgroundImageId: string?): table
	...
	visibilityKeybind = getMatchingKeyCodeFromName(visibilityKeybind) or Enum.KeyCode.RightAlt
	...
	holder.PageLogo.Image = backgroundImageId or "rbxassetid://"
